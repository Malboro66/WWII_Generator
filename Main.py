...
from Functions.utilities import Clipboard
...
menu_arquivo.add_command(label="Salvar como", command=my_clipboard.save_to_file)
...
button_copy = tk.Button(app, text="Copiar", command=my_clipboard.copy_to_clipboard)
